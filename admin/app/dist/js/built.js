...
angular
  ...
  .constant({
    'endpoint': "http://e-commerce-api.au-syd.mybluemix.net/api/v1"//'http://45.55.165.182:3000/api/v1'//'http://ecommerce.provenlogic.xyz/api/v1'//"http://localhost:3000/api/v1"//'http://ecommerce.provenlogic.xyz/api/v1'
  })
...
/**
 * @ngdoc function
 * @name eCommerceAdminApp.controller:CouponListCtrl
 * @description
 * # CouponListCtrl
 * Controller of the eCommerceAdminApp
 */
angular.module('eCommerceAdminApp')
  .controller('CouponListCtrl', function () {
    this.awesomeThings = [
      'HTML5 Boilerplate',
      'AngularJS',
      'Karma'
...
/**
 * @ngdoc function
 * @name eCommerceAdminApp.controller:LicesneListCtrl
 * @description
 * # LicesneListCtrl
 * Controller of the eCommerceAdminApp
 */
angular.module('eCommerceAdminApp')
  .controller('LicesneListCtrl', function () {
    this.awesomeThings = [
      'HTML5 Boilerplate',
      'AngularJS',
      'Karma'
...
/**
 * @ngdoc function
 * @name eCommerceAdminApp.controller:SubscriptionListCtrl
 * @description
 * # SubscriptionListCtrl
 * Controller of the eCommerceAdminApp
 */
angular.module('eCommerceAdminApp')
  .controller('SubscriptionListCtrl', function () {
    this.awesomeThings = [
      'HTML5 Boilerplate',
      'AngularJS',
      'Karma'
