...
angular.module('eCommerceUserApp')
    .controller('LoginCtrl', ['$http', 'Product', '$routeParams', 'UserAuth', 'ConfirmUser', 'sessionService', '$location', '$scope', function($http, Product, $routeParams, UserAuth, ConfirmUser, sessionService, $location, $scope) {
        var _this = this;
